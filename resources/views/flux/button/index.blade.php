...
$classes = Flux::classes()
    ...
    ->add(match ($variant) { // Background color...
        ...
        'filled' => 'bg-zinc-200 hover:bg-zinc-800/10 dark:bg-white/10 dark:hover:bg-white/20',
        ...
        'mine' => 'bg-zinc-200 hover:bg-zinc-300 dark:bg-zinc-800 dark:hover:bg-zinc-600',
    })
    ->add(match ($variant) { // Text color...
        ...
        'mine' => 'text-lg text-zinc-800 dark:text-white justify-center flex items-center p-2 rounded-xl transition-all',
    })
